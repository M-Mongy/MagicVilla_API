...
namespace MagicVilla_VillaAPI.Controllers
{
    ...
    public class VillaAPIController : ControllerBase
    {
        ...
        public VillaAPIController(IVillaReository dbVilla, IMapper mapper)
        {
            _dbVilla = dbVilla;
            _mapper = mapper;
            this._response = new();
        ...
        public async Task<ActionResult<APIReponse>> GetVillas([FromQuery(Name = "filterOccupancy")] int? occupancy,
